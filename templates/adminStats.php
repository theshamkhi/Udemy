...
$totalCoursesByCat = $user->TotalCoursesByCat();
...
<div class="flex-1 ml-0 sm:ml-80 px-24 py-8">
    ...
    <div class="flex flex-col md:flex-row space-x-0 md:space-x-8 mb-8">
        <div class="flex-1 bg-blue-50 p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-semibold text-gray-700">Total Number of Courses</h3>
            <p class="text-4xl font-bold text-blue-500"><?php echo $totalCourses[0]['TotalCourses']; ?></p>
        </div>

        <div class="flex-1 bg-yellow-50 p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-semibold text-gray-700">Most Enrolled Course</h3>
            <?php if ($popularCourse): ?>
                <p class="text-lg text-gray-600"><?php echo $popularCourse['Title']; ?></p>
                <p class="text-3xl font-bold text-yellow-500"><?php echo $popularCourse['StudentCount']; ?> Students</p>
            <?php else: ?>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <h3 class="text-xl font-semibold text-gray-700 mb-4">Courses by Category</h3>
        <table class="min-w-full table-auto border-collapse">
            <thead class="bg-gray-300">
                <tr>
                    <th class="px-6 py-3 text-left text-sm font-medium text-gray-600">Category</th>
                    <th class="px-6 py-3 text-left text-sm font-medium text-gray-600">Total Courses</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($totalCoursesByCat as $category): ?>
                    <tr class="border-b hover:bg-gray-50">
                        <td class="px-6 py-4 text-sm text-gray-700"><?php echo $category['CatName']; ?></td>
                        <td class="px-6 py-4 text-sm font-semibold text-gray-900"><?php echo $category['TotalCourses']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
