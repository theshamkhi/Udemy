...
<div class="mx-auto max-w-screen-xl px-4 py-16 ml-0 sm:ml-80 p-8 sm:px-6 lg:px-8">
  <div class="mx-auto max-w-lg text-center">
    <h1 class="text-3xl font-bold sm:text-4xl">Manage Teachers Accounts</h1>
    ...
    <div class="overflow-auto bg-white shadow-lg" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        <table class="min-w-full table-auto border-collapse text-sm">
            <thead class="bg-black">
                <tr>
                    <th class="px-6 py-3 text-left font-medium text-white">Name</th>
                    <th class="px-6 py-3 text-left font-medium text-white">Email</th>
