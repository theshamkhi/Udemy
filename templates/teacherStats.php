...
$totalEnrolledStudents = $user->EnrolledStudents();
// $popularCourse = $user->getCourseWithMostStudents();
...
<div class="mx-auto max-w-screen-xl px-4 py-16 ml-0 sm:ml-80 p-8 sm:px-6 lg:px-8">
  <div class="mx-auto max-w-lg text-center">
    <h1 class="text-3xl font-bold sm:text-5xl">Statistics</h1>
...
<div class="flex-1 ml-0 sm:ml-80 px-24 py-8">
    <div class="flex flex-col md:flex-row space-x-0 md:space-x-8 mb-8">
        <div class="flex-1 bg-blue-50 p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-semibold text-gray-700">Total Number of My Courses</h3>
            <p class="text-4xl font-bold text-blue-500"><?php echo $totalCourses['TotalCourses']; ?></p>
        </div>

        <div class="flex-1 bg-yellow-50 p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-semibold text-gray-700">Total Enrolled Students in My Courses</h3>
            <?php if ($totalEnrolledStudents): ?>
                <p class="text-3xl font-bold text-yellow-500"><?php echo $totalEnrolledStudents['EnrolledStudents']; ?> Students</p>
            <?php else: ?>
                <p class="text-lg text-gray-600">No enrollment.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
