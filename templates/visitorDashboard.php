...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <div class="flex flex-col space-y-2">
        ...
        <div class="px-3 pt-4">
            <h2 class="text-2xl font-semibold text-white text-center mb-2">Welcome to Udemy</h2>
            <p class="text-sm text-gray-500 text-center">Discover new courses, join communities, and earn badges</p>
        </div>
    </div>
    <ul class="space-y-2 font-medium px-4 pt-4">
            <li>
              <a href="login.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
            ...
            <li>
                <a href="register.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
