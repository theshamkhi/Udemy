...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
  <div class="h-full overflow-y-auto bg-black">
    ...
    <ul class="space-y-2 font-medium px-3 pb-4">
            ...
            <li>
              <a href="enrollments.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
                  <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 20">
...
<div class="h-full overflow-y-auto bg-black">
    ...
    <ul class="space-y-2 font-medium px-3 pb-4">
        <li>
            <a href="teacherDashboard.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                    <path d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857 8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 0 0 18 16.143v-4.286A1.857 1.857 0 0 0 16.143 10Z"/>
                </svg>
            <span class="ms-3">Dashboard</span>
        ...
        <li>
          <a href="teacherCourses.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
              <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 20">
                  <path d="M7.958 19.393a7.7 7.7 0 0 1-6.715-3.439c-2.868-4.832 0-9.376.944-10.654l.091-.122a3.286 3.286 0 0 0 .765-3.288A1 1 0 0 1 4.6.8c.133.1.313.212.525.347A10.451 10.451 0 0 1 10.6 9.3c.5-1.06.772-2.213.8-3.385a1 1 0 0 1 1.592-.758c1.636 1.205 4.638 6.081 2.019 10.441a8.177 8.177 0 0 1-7.053 3.795Z"/>
              </svg>
        ...
        <li>
          <a href="teacherStats.php" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-100 hover:text-black group">
...
<!-- Main -->
<div class="flex-1 ml-0 sm:ml-80 p-8 bg-gray-100">
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-start px-8 text-white">
        ...
        <div class="p-6 sm:p-8">
            <div class="flex flex-wrap justify-between items-center border-b pb-4 mb-4">
                <div class="flex items-center space-x-4">
                    <img src="https://static.vecteezy.com/system/resources/previews/006/131/297/non_2x/man-illustration-vector.jpg" alt="Teacher" class="w-12 h-12 rounded-full">
                    <div>
                        <p class="text-sm text-gray-800">Taught by</p>
                        <h2 class="font-semibold"><?php echo $course['Name']; ?></h2>
                    </div>
                </div>
                <div>
                    <p class="text-sm text-gray-800">Category</p>
                    <h2 class="font-semibold"><?php echo $course['CatName']; ?></h2>
                </div>
                <div>
                    <p class="text-sm text-gray-800">Duration</p>
                    <h2 class="font-semibold">4 months</h2>
                </div>
                <div>
                    <p class="text-sm text-gray-800">Tags</p>
                    <?php foreach ($course['Tags'] as $tag): ?>
                        <span class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded"><?php echo $tag; ?></span>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <ul class="grid grid-cols-2 sm:grid-cols-3 gap-8 mt-2 text-gray-700">
                  <li class="flex items-center space-x-2">
                      <svg class="w-7 h-7 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <?php if ($_SESSION['role'] == 'Student'): ?>
              <div class="flex items-center justify-center space-x-2">
                  <form method="POST">
                      ...
                      <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded shadow-lg transition">
                          Enroll Now
                      </button>
                  </form>
              </div>
